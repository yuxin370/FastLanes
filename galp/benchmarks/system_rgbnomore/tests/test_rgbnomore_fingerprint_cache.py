...
from galp.benchmarks.system_rgbnomore.shared.common import cached_file_fingerprints, file_identity  # noqa: E402
...
class PayloadFingerprintCacheTest(unittest.TestCase):
    ...
    def test_device_remap_reuses_digest_without_rewriting_cache(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with mock.patch(
                "galp.benchmarks.system_rgbnomore.shared.common.fingerprint_file",
