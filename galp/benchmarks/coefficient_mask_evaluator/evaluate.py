...
from galp.benchmarks.coefficient_mask_evaluator.masks import (
    MaskCondition,
    build_conditions,
    masks_numpy,
    select_conditions,
...
from galp.benchmarks.common import DEFAULT_RGBNOMORE_ROOT, sha256_file
...
def load_progress(output_dir: Path, resume: bool) -> EvaluatorProgress:
    ...
    inference_seconds = float(progress["inference_seconds"])
