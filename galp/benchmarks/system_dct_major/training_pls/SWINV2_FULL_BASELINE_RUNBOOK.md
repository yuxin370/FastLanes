...
LAYOUT=/mnt/nvme2/home/tangyuxin/pls-experiments/pls-layout-20260811/physical_layout_plan.json
PHYSICAL=/mnt/nvme2/home/tangyuxin/pls-experiments/physical-layout-full-premix-orgseed-20260810/uniform_premix/dct/manifest.bin
MAPPING=/mnt/nvme2/home/tangyuxin/pls-experiments/physical-layout-full-premix-orgseed-20260810/uniform_premix/ordered_mapping.csv
...
PERF_SUITE=/mnt/nvme2/home/tangyuxin/pls-experiments/swinv2-training-performance-e2-4090-20260912-v1
PERF_RGBNOMORE=$PERF_SUITE/rgbnomore_dct
MODEL=rgbnomore-swinv2-t-dct-224-v1

export PYTHONDONTWRITEBYTECODE=1
export PYTHONPATH=$PWD/galp/benchmarks/system_dct_major:$PWD/galp/benchmarks/system_rgbnomore:$PWD/build/galp/torch
```
...
```bash
"$PY" -m training_pls.report_convergence_reference \
...
for PIPELINE in d2 d3 pytorch; do
  "$PY" -m training.equal_image_epoch_benchmark \
    --train-manifest "$TRAIN" \
    --val-manifest "$VAL" \
...
```bash
"$PY" -m training_pls.report_equal_image_performance \
