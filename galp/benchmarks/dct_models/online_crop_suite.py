...
def main():
    ...
    for profile in args.profiles:
        ...
        driver = [sys.executable, "-m", "galp.benchmarks.dct_models.efun", "evaluate_shards"] if profile == "efun" else [sys.executable, "-m", "galp.benchmarks.dct_models.evaluate_shards"]
        ...
        if not args.skip_profile:
            for name, command in rows:
                ...
                subprocess.run([sys.executable, "-m", "galp.benchmarks.dct_models.analyze_profiles", out], check=True, env=env)
