...
REPO = HERE.parents[2]
from galp.benchmarks.system_rgbnomore.inference.run import (DEFAULT_CHECKPOINT_DIR, DEFAULT_DATA_ROOT,
...
VALIDATION_DATA = REPO / "galp/data/compressed/backup/offline_model_input/imagenet512_val_efun28_block_major"
