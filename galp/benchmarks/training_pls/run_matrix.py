...
from galp.benchmarks.system_rgbnomore.training.artifacts import tensor_state_sha256  # noqa: E402
from galp.benchmarks.system_rgbnomore.training.model_factory import seed_everything  # noqa: E402
...
def _write_or_validate_contract(path: Path, payload: Mapping[str, Any]) -> None:
    ...
    if path.exists():
        ...
        if (
            ...
            and condition_identity_hash(observed) != condition_identity_hash(payload)
        ):
            raise ValueError(
...
def build_plan(args: argparse.Namespace) -> dict[str, Any]:
    ...
    for row in execution_rows:
        ...
        argv = [
            ...
            "-m",
            "galp.benchmarks.training_pls.train",
            "--train-manifest",
