...
BENCHMARK_ROOT = Path(__file__).resolve().parents[1] / "system_rgbnomore"

from galp.benchmarks.system_rgbnomore.training.augmentation import AugmentationDecision  # noqa: E402
