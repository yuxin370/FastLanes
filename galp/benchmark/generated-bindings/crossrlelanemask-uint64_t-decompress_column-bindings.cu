...
template <>
uint64_t* decompress_column<uint64_t, flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>(
    const flsgpu::device::CROSSRLELaneMaskColumn<uint64_t> column,
	...
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && expander == enums::Expander::Branchless) {
		return kernels::host::decompress_column<
		    ...
		    flsgpu::device::CROSSRLEDecompressor<uint64_t,
		                                         1,
		                                         flsgpu::device::BranchlessCROSSRLEExpander<uint64_t, 1, 1>,
		                                         flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>,
		    flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>(column, n_samples);
	}
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && expander == enums::Expander::PrefetchBranchless) {
		return kernels::host::decompress_column<
		    ...
		    flsgpu::device::CROSSRLEDecompressor<uint64_t,
		                                         1,
		                                         flsgpu::device::PrefetchBranchlessCROSSRLEExpander<uint64_t, 1, 1>,
		                                         flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>,
		    flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>(column, n_samples);
	}
	if (unpack_n_vectors == 4 && unpack_n_values == 1 && expander == enums::Expander::Branchless) {
		return kernels::host::decompress_column<
		    ...
		    flsgpu::device::CROSSRLEDecompressor<uint64_t,
		                                         4,
		                                         flsgpu::device::BranchlessCROSSRLEExpander<uint64_t, 4, 1>,
		                                         flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>,
		    flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>(column, n_samples);
	}
	if (unpack_n_vectors == 4 && unpack_n_values == 1 && expander == enums::Expander::PrefetchBranchless) {
		return kernels::host::decompress_column<
		    ...
		    flsgpu::device::CROSSRLEDecompressor<uint64_t,
		                                         4,
		                                         flsgpu::device::PrefetchBranchlessCROSSRLEExpander<uint64_t, 4, 1>,
		                                         flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>,
		    flsgpu::device::CROSSRLELaneMaskColumn<uint64_t>>(column, n_samples);
	}
