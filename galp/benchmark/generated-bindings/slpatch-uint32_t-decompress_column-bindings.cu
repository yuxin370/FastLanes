...
template <>
uint32_t* decompress_column<uint32_t, galp::codec::device::SLPATCHColumn<uint32_t>>(
    const galp::codec::device::SLPATCHColumn<uint32_t> column,
	...
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::Dummy &&
		...
		return galp::kernels::host::decompress_column<
		    ...
		    galp::codec::device::SLPATCHDecompressor<
		        ...
		        galp::codec::device::StatefulSLPATCHExceptionPatcher<uint32_t, 1, 1>,
		        galp::codec::device::SLPATCHColumn<uint32_t>>,
		    galp::codec::device::SLPATCHColumn<uint32_t>>(column, n_samples);
	}
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::Dummy &&
		...
		return galp::kernels::host::decompress_column<
		    ...
		    galp::codec::device::SLPATCHDecompressor<
		        ...
		        1,
		        galp::codec::device::BitUnpackerDummy<uint32_t, 1, 1, galp::codec::device::FFORFunctor<uint32_t, 1>>,
		        galp::codec::device::StatelessSLPATCHExceptionPatcher<uint32_t, 1, 1>,
		        galp::codec::device::SLPATCHColumn<uint32_t>>,
		    galp::codec::device::SLPATCHColumn<uint32_t>>(column, n_samples);
	}
	if (unpack_n_vectors == 1 && unpack_n_values == 32 && unpacker == galp::format::Unpacker::OldFls &&
		...
		return galp::kernels::host::decompress_column<
		    ...
		    galp::codec::device::SLPATCHDecompressor<
		        ...
		        galp::codec::device::StatefulSLPATCHExceptionPatcher<uint32_t, 1, 32>,
		        galp::codec::device::SLPATCHColumn<uint32_t>>,
		    galp::codec::device::SLPATCHColumn<uint32_t>>(column, n_samples);
	}
	if (unpack_n_vectors == 1 && unpack_n_values == 32 && unpacker == galp::format::Unpacker::OldFls &&
		...
		return galp::kernels::host::decompress_column<
		    ...
		    galp::codec::device::SLPATCHDecompressor<
		        ...
		        1,
		        galp::codec::device::BitUnpackerOldFls<uint32_t, 1, 32, galp::codec::device::FFORFunctor<uint32_t, 1>>,
		        galp::codec::device::StatelessSLPATCHExceptionPatcher<uint32_t, 1, 32>,
		        galp::codec::device::SLPATCHColumn<uint32_t>>,
		    galp::codec::device::SLPATCHColumn<uint32_t>>(column, n_samples);
	}
	...
	if (unpack_n_vectors == 4 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::Dummy &&
		...
		return galp::kernels::host::decompress_column<
		    ...
		    galp::codec::device::SLPATCHDecompressor<
		        ...
		        galp::codec::device::StatefulSLPATCHExceptionPatcher<uint32_t, 4, 1>,
		        galp::codec::device::SLPATCHColumn<uint32_t>>,
		    galp::codec::device::SLPATCHColumn<uint32_t>>(column, n_samples);
	}
	if (unpack_n_vectors == 4 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::Dummy &&
		...
		return galp::kernels::host::decompress_column<
		    ...
		    galp::codec::device::SLPATCHDecompressor<
		        ...
		        4,
		        galp::codec::device::BitUnpackerDummy<uint32_t, 4, 1, galp::codec::device::FFORFunctor<uint32_t, 4>>,
		        galp::codec::device::StatelessSLPATCHExceptionPatcher<uint32_t, 4, 1>,
		        galp::codec::device::SLPATCHColumn<uint32_t>>,
		    galp::codec::device::SLPATCHColumn<uint32_t>>(column, n_samples);
	}
