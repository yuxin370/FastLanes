...
template <>
bool query_column<uint64_t, galp::codec::device::BPColumn<uint64_t>>(const galp::codec::device::BPColumn<uint64_t> column,
	...
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::Dummy &&
		...
		return galp::kernels::host::query_column<
		    ...
		    galp::codec::device::BPDecompressor<
		        uint64_t,
		        1,
		        galp::codec::device::BitUnpackerDummy<uint64_t, 1, 1, galp::codec::device::BPFunctor<uint64_t>>,
		        galp::codec::device::BPColumn<uint64_t>>,
		    galp::codec::device::BPColumn<uint64_t>>(column, magic_value, n_samples);
	}
	...
	if (unpack_n_vectors == 1 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::StatefulBranchless &&
		...
		return galp::kernels::host::query_column<
		    ...
		    galp::codec::device::BPDecompressor<
		        uint64_t,
		        1,
		        galp::codec::device::BitUnpackerStatefulBranchless<uint64_t, 1, 1, galp::codec::device::BPFunctor<uint64_t>>,
		        galp::codec::device::BPColumn<uint64_t>>,
		    galp::codec::device::BPColumn<uint64_t>>(column, magic_value, n_samples);
	}
	if (unpack_n_vectors == 4 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::Dummy &&
		...
		return galp::kernels::host::query_column<
		    ...
		    galp::codec::device::BPDecompressor<
		        uint64_t,
		        4,
		        galp::codec::device::BitUnpackerDummy<uint64_t, 4, 1, galp::codec::device::BPFunctor<uint64_t>>,
		        galp::codec::device::BPColumn<uint64_t>>,
		    galp::codec::device::BPColumn<uint64_t>>(column, magic_value, n_samples);
	}
	...
	if (unpack_n_vectors == 4 && unpack_n_values == 1 && unpacker == galp::format::Unpacker::StatefulBranchless &&
		...
		return galp::kernels::host::query_column<
		    ...
		    galp::codec::device::BPDecompressor<
		        uint64_t,
		        4,
		        galp::codec::device::BitUnpackerStatefulBranchless<uint64_t, 4, 1, galp::codec::device::BPFunctor<uint64_t>>,
		        galp::codec::device::BPColumn<uint64_t>>,
		    galp::codec::device::BPColumn<uint64_t>>(column, magic_value, n_samples);
	}
