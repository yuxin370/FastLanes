...
template <>
bool query_multi_column<uint32_t, galp::codec::host::FFORColumn<uint32_t>>(const galp::codec::host::FFORColumn<uint32_t>& column,
	...
	if (unpack_n_vectors == 1 && unpack_n_values == 32 && unpacker == galp::format::Unpacker::OldFls &&
		...
		return galp::kernels::host::query_multi_column<
		    ...
		    galp::codec::host::FFORColumn<uint32_t>>(column, magic_value, n_samples);
	}
