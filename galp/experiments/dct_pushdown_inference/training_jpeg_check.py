...
from training_jpeg import JpegDctDataset
...
def main():
    ...
    from evaluate_shards import native_options
    from training_pls.published_augmentation import published_training_augmentation
    transforms = []
