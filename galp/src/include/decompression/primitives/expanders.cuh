...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// galp/src/include/decompression/primitives/expanders.cuh
// ────────────────────────────────────────────────────────
#ifndef GALP_DECOMPRESSION_PRIMITIVES_EXPANDERS_CUH
#define GALP_DECOMPRESSION_PRIMITIVES_EXPANDERS_CUH

#include "compression/device-types.cuh"
#include "decompression/primitives/functors.cuh"
			...
			for (int i = 0; i < (int)UNPACK_N_VALUES; ++i) {
				...
				for (;;) {
					...
					if (lane == 0) {
						...
						// If this run does not cover the strip, advance to the next run.
...
#endif // GALP_DECOMPRESSION_PRIMITIVES_EXPANDERS_CUH
