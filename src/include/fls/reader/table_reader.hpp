...
public:
	...
	std::vector<std::vector<std::vector<double>>> to_rgb(const path& file_path) const;
	std::vector<std::vector<std::vector<double>>> to_rgb(const string& file_path) const;
	std::vector<std::vector<std::vector<double>>> to_rgb(const char* file_path) const;
private:
