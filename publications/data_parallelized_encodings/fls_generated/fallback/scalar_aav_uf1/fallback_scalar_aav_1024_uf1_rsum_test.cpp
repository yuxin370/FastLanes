...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/fallback/scalar_aav_uf1/fallback_scalar_aav_1024_uf1_rsum_test.cpp
// ────────────────────────────────────────────────────────
...
class fallback_scalar_aav_1024_uf1_rsum : public ::testing::Test {
public:
	uint8_t*  transposed8;
	...
	~fallback_scalar_aav_1024_uf1_rsum() override {
		delete[] transposed8;
		delete[] transposed16;
		delete[] transposed32;
		delete[] transposed64;
...
TEST_F(fallback_scalar_aav_1024_uf1_rsum, test_0_ow_8_rsum) {
...
TEST_F(fallback_scalar_aav_1024_uf1_rsum, test_1_ow_16_rsum) {
...
TEST_F(fallback_scalar_aav_1024_uf1_rsum, test_2_ow_32_rsum) {
...
TEST_F(fallback_scalar_aav_1024_uf1_rsum, test_3_ow_64_rsum) {
