...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/fallback/unit64_nav_uf1/fallback_unit64_nav_1024_uf1_unffor_bench.cpp
// ────────────────────────────────────────────────────────
#include "fallback_unit64_nav_1024_uf1_unffor_bench.hpp"
#include "fallback_unit64_nav_1024_uf1_unffor_helper.hpp"
#include "fls_gen/ffor/ffor.hpp"
#include "fls_gen/pack/pack.hpp"
#include "fls_gen/unffor/unffor.hpp"
#include <iostream>
static benchmark::BenchmarkReporter::Run bench0_unpack_0bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	std::string                    benchmark_name = "bench0_unpack_0bw_8ow_64crw_1uf";
	...
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 0, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench1_unpack_1bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench1_unpack_1bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 1, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench2_unpack_2bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench2_unpack_2bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 2, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench3_unpack_3bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench3_unpack_3bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 3, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench4_unpack_4bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench4_unpack_4bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 4, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench5_unpack_5bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench5_unpack_5bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 5, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench6_unpack_6bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench6_unpack_6bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 6, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench7_unpack_7bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench7_unpack_7bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 7, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench8_unpack_8bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	[[maybe_unused]] const uint8_t base8[1]       = {1};
	std::string                    benchmark_name = "bench8_unpack_8bw_8ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed8, const_cast<uint8_t*>(unpacked8), 8, base8);
	}
...
static benchmark::BenchmarkReporter::Run bench9_unpack_0bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                          uint16_t*       unpacked16) {
	...
	std::string                     benchmark_name = "bench9_unpack_0bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 0, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench10_unpack_1bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench10_unpack_1bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 1, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench11_unpack_2bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench11_unpack_2bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 2, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench12_unpack_3bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench12_unpack_3bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 3, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench13_unpack_4bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench13_unpack_4bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 4, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench14_unpack_5bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench14_unpack_5bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 5, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench15_unpack_6bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench15_unpack_6bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 6, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench16_unpack_7bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench16_unpack_7bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 7, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench17_unpack_8bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench17_unpack_8bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 8, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench18_unpack_9bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                           uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench18_unpack_9bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 9, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench19_unpack_10bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                            uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench19_unpack_10bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 10, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench20_unpack_11bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                            uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench20_unpack_11bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 11, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench21_unpack_12bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                            uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench21_unpack_12bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 12, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench22_unpack_13bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                            uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench22_unpack_13bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 13, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench23_unpack_14bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                            uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench23_unpack_14bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 14, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench24_unpack_15bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                            uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench24_unpack_15bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 15, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench25_unpack_16bw_16ow_64crw_1uf(const uint16_t* packed16,
                                                                            uint16_t*       unpacked16) {
	...
	[[maybe_unused]] const uint16_t base16[1]      = {1};
	std::string                     benchmark_name = "bench25_unpack_16bw_16ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed16, const_cast<uint16_t*>(unpacked16), 16, base16);
	}
...
static benchmark::BenchmarkReporter::Run bench26_unpack_0bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	std::string                     benchmark_name = "bench26_unpack_0bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 0, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench27_unpack_1bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench27_unpack_1bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 1, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench28_unpack_2bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench28_unpack_2bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 2, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench29_unpack_3bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench29_unpack_3bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 3, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench30_unpack_4bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench30_unpack_4bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 4, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench31_unpack_5bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench31_unpack_5bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 5, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench32_unpack_6bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench32_unpack_6bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 6, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench33_unpack_7bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench33_unpack_7bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 7, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench34_unpack_8bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench34_unpack_8bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 8, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench35_unpack_9bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                           uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench35_unpack_9bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 9, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench36_unpack_10bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench36_unpack_10bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 10, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench37_unpack_11bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench37_unpack_11bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 11, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench38_unpack_12bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench38_unpack_12bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 12, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench39_unpack_13bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench39_unpack_13bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 13, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench40_unpack_14bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench40_unpack_14bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 14, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench41_unpack_15bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench41_unpack_15bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 15, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench42_unpack_16bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench42_unpack_16bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 16, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench43_unpack_17bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench43_unpack_17bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 17, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench44_unpack_18bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench44_unpack_18bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 18, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench45_unpack_19bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench45_unpack_19bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 19, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench46_unpack_20bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench46_unpack_20bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 20, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench47_unpack_21bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench47_unpack_21bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 21, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench48_unpack_22bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench48_unpack_22bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 22, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench49_unpack_23bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench49_unpack_23bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 23, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench50_unpack_24bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench50_unpack_24bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 24, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench51_unpack_25bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench51_unpack_25bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 25, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench52_unpack_26bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench52_unpack_26bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 26, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench53_unpack_27bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench53_unpack_27bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 27, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench54_unpack_28bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench54_unpack_28bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 28, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench55_unpack_29bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench55_unpack_29bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 29, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench56_unpack_30bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench56_unpack_30bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 30, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench57_unpack_31bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench57_unpack_31bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 31, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench58_unpack_32bw_32ow_64crw_1uf(const uint32_t* packed32,
                                                                            uint32_t*       unpacked32) {
	...
	[[maybe_unused]] const uint32_t base32[1]      = {1};
	std::string                     benchmark_name = "bench58_unpack_32bw_32ow_64crw_1uf";
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed32, const_cast<uint32_t*>(unpacked32), 32, base32);
	}
...
static benchmark::BenchmarkReporter::Run bench59_unpack_0bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 0, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench60_unpack_1bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 1, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench61_unpack_2bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 2, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench62_unpack_3bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 3, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench63_unpack_4bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 4, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench64_unpack_5bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 5, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench65_unpack_6bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 6, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench66_unpack_7bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 7, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench67_unpack_8bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 8, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench68_unpack_9bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 9, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench69_unpack_10bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 10, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench70_unpack_11bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 11, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench71_unpack_12bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 12, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench72_unpack_13bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 13, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench73_unpack_14bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 14, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench74_unpack_15bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 15, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench75_unpack_16bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 16, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench76_unpack_17bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 17, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench77_unpack_18bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 18, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench78_unpack_19bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 19, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench79_unpack_20bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 20, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench80_unpack_21bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 21, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench81_unpack_22bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 22, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench82_unpack_23bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 23, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench83_unpack_24bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 24, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench84_unpack_25bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 25, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench85_unpack_26bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 26, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench86_unpack_27bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 27, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench87_unpack_28bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 28, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench88_unpack_29bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 29, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench89_unpack_30bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 30, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench90_unpack_31bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 31, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench91_unpack_32bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 32, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench92_unpack_33bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 33, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench93_unpack_34bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 34, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench94_unpack_35bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 35, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench95_unpack_36bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 36, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench96_unpack_37bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 37, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench97_unpack_38bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 38, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench98_unpack_39bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 39, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench99_unpack_40bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 40, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench100_unpack_41bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 41, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench101_unpack_42bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 42, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench102_unpack_43bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 43, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench103_unpack_44bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 44, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench104_unpack_45bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 45, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench105_unpack_46bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 46, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench106_unpack_47bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 47, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench107_unpack_48bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 48, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench108_unpack_49bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 49, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench109_unpack_50bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 50, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench110_unpack_51bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 51, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench111_unpack_52bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 52, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench112_unpack_53bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 53, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench113_unpack_54bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 54, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench114_unpack_55bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 55, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench115_unpack_56bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 56, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench116_unpack_57bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 57, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench117_unpack_58bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 58, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench118_unpack_59bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 59, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench119_unpack_60bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 60, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench120_unpack_61bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 61, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench121_unpack_62bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 62, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench122_unpack_63bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 63, base64);
	}
...
static benchmark::BenchmarkReporter::Run bench123_unpack_64bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unffor::fallback::unit64::unffor(packed64, const_cast<uint64_t*>(unpacked64), 64, base64);
	}
...
void benchmark_all(benchmark::Benchmark& benchmark) {
	...
	benchmark.Run(bench0_unpack_0bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench1_unpack_1bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench2_unpack_2bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench3_unpack_3bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench4_unpack_4bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench5_unpack_5bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench6_unpack_6bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench7_unpack_7bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench8_unpack_8bw_8ow_64crw_1uf(packed8, unpacked8));
	benchmark.Run(bench9_unpack_0bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench10_unpack_1bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench11_unpack_2bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench12_unpack_3bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench13_unpack_4bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench14_unpack_5bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench15_unpack_6bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench16_unpack_7bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench17_unpack_8bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench18_unpack_9bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench19_unpack_10bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench20_unpack_11bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench21_unpack_12bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench22_unpack_13bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench23_unpack_14bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench24_unpack_15bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench25_unpack_16bw_16ow_64crw_1uf(packed16, unpacked16));
	benchmark.Run(bench26_unpack_0bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench27_unpack_1bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench28_unpack_2bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench29_unpack_3bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench30_unpack_4bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench31_unpack_5bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench32_unpack_6bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench33_unpack_7bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench34_unpack_8bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench35_unpack_9bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench36_unpack_10bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench37_unpack_11bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench38_unpack_12bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench39_unpack_13bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench40_unpack_14bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench41_unpack_15bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench42_unpack_16bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench43_unpack_17bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench44_unpack_18bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench45_unpack_19bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench46_unpack_20bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench47_unpack_21bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench48_unpack_22bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench49_unpack_23bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench50_unpack_24bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench51_unpack_25bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench52_unpack_26bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench53_unpack_27bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench54_unpack_28bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench55_unpack_29bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench56_unpack_30bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench57_unpack_31bw_32ow_64crw_1uf(packed32, unpacked32));
	benchmark.Run(bench58_unpack_32bw_32ow_64crw_1uf(packed32, unpacked32));
...
int main() {
	benchmark::Benchmark benchmark =
	    benchmark::create("fallback_unit64_nav_1024_uf1_unffor")
	        .save()
