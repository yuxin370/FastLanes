...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/fallback/unit64_nav_uf1/fallback_unit64_nav_1024_uf1_unpack_bench.cpp
// ────────────────────────────────────────────────────────
#include "fallback_unit64_nav_1024_uf1_unpack_bench.hpp"
#include "fallback_unit64_nav_1024_uf1_unpack_helper.hpp"
...
static benchmark::BenchmarkReporter::Run bench0_unpack_0bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 0);
	}
...
static benchmark::BenchmarkReporter::Run bench1_unpack_1bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 1);
	}
...
static benchmark::BenchmarkReporter::Run bench2_unpack_2bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 2);
	}
...
static benchmark::BenchmarkReporter::Run bench3_unpack_3bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 3);
	}
...
static benchmark::BenchmarkReporter::Run bench4_unpack_4bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 4);
	}
...
static benchmark::BenchmarkReporter::Run bench5_unpack_5bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 5);
	}
...
static benchmark::BenchmarkReporter::Run bench6_unpack_6bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 6);
	}
...
static benchmark::BenchmarkReporter::Run bench7_unpack_7bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 7);
	}
...
static benchmark::BenchmarkReporter::Run bench8_unpack_8bw_8ow_64crw_1uf(const uint8_t* packed8, uint8_t* unpacked8) {
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed8, const_cast<uint8_t*>(unpacked8), 8);
	}
...
static benchmark::BenchmarkReporter::Run bench9_unpack_0bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 0);
	}
...
static benchmark::BenchmarkReporter::Run bench10_unpack_1bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 1);
	}
...
static benchmark::BenchmarkReporter::Run bench11_unpack_2bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 2);
	}
...
static benchmark::BenchmarkReporter::Run bench12_unpack_3bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 3);
	}
...
static benchmark::BenchmarkReporter::Run bench13_unpack_4bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 4);
	}
...
static benchmark::BenchmarkReporter::Run bench14_unpack_5bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 5);
	}
...
static benchmark::BenchmarkReporter::Run bench15_unpack_6bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 6);
	}
...
static benchmark::BenchmarkReporter::Run bench16_unpack_7bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 7);
	}
...
static benchmark::BenchmarkReporter::Run bench17_unpack_8bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 8);
	}
...
static benchmark::BenchmarkReporter::Run bench18_unpack_9bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 9);
	}
...
static benchmark::BenchmarkReporter::Run bench19_unpack_10bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 10);
	}
...
static benchmark::BenchmarkReporter::Run bench20_unpack_11bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 11);
	}
...
static benchmark::BenchmarkReporter::Run bench21_unpack_12bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 12);
	}
...
static benchmark::BenchmarkReporter::Run bench22_unpack_13bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 13);
	}
...
static benchmark::BenchmarkReporter::Run bench23_unpack_14bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 14);
	}
...
static benchmark::BenchmarkReporter::Run bench24_unpack_15bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 15);
	}
...
static benchmark::BenchmarkReporter::Run bench25_unpack_16bw_16ow_64crw_1uf(const uint16_t* packed16,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed16, const_cast<uint16_t*>(unpacked16), 16);
	}
...
static benchmark::BenchmarkReporter::Run bench26_unpack_0bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 0);
	}
...
static benchmark::BenchmarkReporter::Run bench27_unpack_1bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 1);
	}
...
static benchmark::BenchmarkReporter::Run bench28_unpack_2bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 2);
	}
...
static benchmark::BenchmarkReporter::Run bench29_unpack_3bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 3);
	}
...
static benchmark::BenchmarkReporter::Run bench30_unpack_4bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 4);
	}
...
static benchmark::BenchmarkReporter::Run bench31_unpack_5bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 5);
	}
...
static benchmark::BenchmarkReporter::Run bench32_unpack_6bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 6);
	}
...
static benchmark::BenchmarkReporter::Run bench33_unpack_7bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 7);
	}
...
static benchmark::BenchmarkReporter::Run bench34_unpack_8bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 8);
	}
...
static benchmark::BenchmarkReporter::Run bench35_unpack_9bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 9);
	}
...
static benchmark::BenchmarkReporter::Run bench36_unpack_10bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 10);
	}
...
static benchmark::BenchmarkReporter::Run bench37_unpack_11bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 11);
	}
...
static benchmark::BenchmarkReporter::Run bench38_unpack_12bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 12);
	}
...
static benchmark::BenchmarkReporter::Run bench39_unpack_13bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 13);
	}
...
static benchmark::BenchmarkReporter::Run bench40_unpack_14bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 14);
	}
...
static benchmark::BenchmarkReporter::Run bench41_unpack_15bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 15);
	}
...
static benchmark::BenchmarkReporter::Run bench42_unpack_16bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 16);
	}
...
static benchmark::BenchmarkReporter::Run bench43_unpack_17bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 17);
	}
...
static benchmark::BenchmarkReporter::Run bench44_unpack_18bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 18);
	}
...
static benchmark::BenchmarkReporter::Run bench45_unpack_19bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 19);
	}
...
static benchmark::BenchmarkReporter::Run bench46_unpack_20bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 20);
	}
...
static benchmark::BenchmarkReporter::Run bench47_unpack_21bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 21);
	}
...
static benchmark::BenchmarkReporter::Run bench48_unpack_22bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 22);
	}
...
static benchmark::BenchmarkReporter::Run bench49_unpack_23bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 23);
	}
...
static benchmark::BenchmarkReporter::Run bench50_unpack_24bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 24);
	}
...
static benchmark::BenchmarkReporter::Run bench51_unpack_25bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 25);
	}
...
static benchmark::BenchmarkReporter::Run bench52_unpack_26bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 26);
	}
...
static benchmark::BenchmarkReporter::Run bench53_unpack_27bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 27);
	}
...
static benchmark::BenchmarkReporter::Run bench54_unpack_28bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 28);
	}
...
static benchmark::BenchmarkReporter::Run bench55_unpack_29bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 29);
	}
...
static benchmark::BenchmarkReporter::Run bench56_unpack_30bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 30);
	}
...
static benchmark::BenchmarkReporter::Run bench57_unpack_31bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 31);
	}
...
static benchmark::BenchmarkReporter::Run bench58_unpack_32bw_32ow_64crw_1uf(const uint32_t* packed32,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed32, const_cast<uint32_t*>(unpacked32), 32);
	}
...
static benchmark::BenchmarkReporter::Run bench59_unpack_0bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 0);
	}
...
static benchmark::BenchmarkReporter::Run bench60_unpack_1bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 1);
	}
...
static benchmark::BenchmarkReporter::Run bench61_unpack_2bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 2);
	}
...
static benchmark::BenchmarkReporter::Run bench62_unpack_3bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 3);
	}
...
static benchmark::BenchmarkReporter::Run bench63_unpack_4bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 4);
	}
...
static benchmark::BenchmarkReporter::Run bench64_unpack_5bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 5);
	}
...
static benchmark::BenchmarkReporter::Run bench65_unpack_6bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 6);
	}
...
static benchmark::BenchmarkReporter::Run bench66_unpack_7bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 7);
	}
...
static benchmark::BenchmarkReporter::Run bench67_unpack_8bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 8);
	}
...
static benchmark::BenchmarkReporter::Run bench68_unpack_9bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 9);
	}
...
static benchmark::BenchmarkReporter::Run bench69_unpack_10bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 10);
	}
...
static benchmark::BenchmarkReporter::Run bench70_unpack_11bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 11);
	}
...
static benchmark::BenchmarkReporter::Run bench71_unpack_12bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 12);
	}
...
static benchmark::BenchmarkReporter::Run bench72_unpack_13bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 13);
	}
...
static benchmark::BenchmarkReporter::Run bench73_unpack_14bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 14);
	}
...
static benchmark::BenchmarkReporter::Run bench74_unpack_15bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 15);
	}
...
static benchmark::BenchmarkReporter::Run bench75_unpack_16bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 16);
	}
...
static benchmark::BenchmarkReporter::Run bench76_unpack_17bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 17);
	}
...
static benchmark::BenchmarkReporter::Run bench77_unpack_18bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 18);
	}
...
static benchmark::BenchmarkReporter::Run bench78_unpack_19bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 19);
	}
...
static benchmark::BenchmarkReporter::Run bench79_unpack_20bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 20);
	}
...
static benchmark::BenchmarkReporter::Run bench80_unpack_21bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 21);
	}
...
static benchmark::BenchmarkReporter::Run bench81_unpack_22bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 22);
	}
...
static benchmark::BenchmarkReporter::Run bench82_unpack_23bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 23);
	}
...
static benchmark::BenchmarkReporter::Run bench83_unpack_24bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 24);
	}
...
static benchmark::BenchmarkReporter::Run bench84_unpack_25bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 25);
	}
...
static benchmark::BenchmarkReporter::Run bench85_unpack_26bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 26);
	}
...
static benchmark::BenchmarkReporter::Run bench86_unpack_27bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 27);
	}
...
static benchmark::BenchmarkReporter::Run bench87_unpack_28bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 28);
	}
...
static benchmark::BenchmarkReporter::Run bench88_unpack_29bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 29);
	}
...
static benchmark::BenchmarkReporter::Run bench89_unpack_30bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 30);
	}
...
static benchmark::BenchmarkReporter::Run bench90_unpack_31bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 31);
	}
...
static benchmark::BenchmarkReporter::Run bench91_unpack_32bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 32);
	}
...
static benchmark::BenchmarkReporter::Run bench92_unpack_33bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 33);
	}
...
static benchmark::BenchmarkReporter::Run bench93_unpack_34bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 34);
	}
...
static benchmark::BenchmarkReporter::Run bench94_unpack_35bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 35);
	}
...
static benchmark::BenchmarkReporter::Run bench95_unpack_36bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 36);
	}
...
static benchmark::BenchmarkReporter::Run bench96_unpack_37bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 37);
	}
...
static benchmark::BenchmarkReporter::Run bench97_unpack_38bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 38);
	}
...
static benchmark::BenchmarkReporter::Run bench98_unpack_39bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 39);
	}
...
static benchmark::BenchmarkReporter::Run bench99_unpack_40bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 40);
	}
...
static benchmark::BenchmarkReporter::Run bench100_unpack_41bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 41);
	}
...
static benchmark::BenchmarkReporter::Run bench101_unpack_42bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 42);
	}
...
static benchmark::BenchmarkReporter::Run bench102_unpack_43bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 43);
	}
...
static benchmark::BenchmarkReporter::Run bench103_unpack_44bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 44);
	}
...
static benchmark::BenchmarkReporter::Run bench104_unpack_45bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 45);
	}
...
static benchmark::BenchmarkReporter::Run bench105_unpack_46bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 46);
	}
...
static benchmark::BenchmarkReporter::Run bench106_unpack_47bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 47);
	}
...
static benchmark::BenchmarkReporter::Run bench107_unpack_48bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 48);
	}
...
static benchmark::BenchmarkReporter::Run bench108_unpack_49bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 49);
	}
...
static benchmark::BenchmarkReporter::Run bench109_unpack_50bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 50);
	}
...
static benchmark::BenchmarkReporter::Run bench110_unpack_51bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 51);
	}
...
static benchmark::BenchmarkReporter::Run bench111_unpack_52bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 52);
	}
...
static benchmark::BenchmarkReporter::Run bench112_unpack_53bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 53);
	}
...
static benchmark::BenchmarkReporter::Run bench113_unpack_54bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 54);
	}
...
static benchmark::BenchmarkReporter::Run bench114_unpack_55bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 55);
	}
...
static benchmark::BenchmarkReporter::Run bench115_unpack_56bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 56);
	}
...
static benchmark::BenchmarkReporter::Run bench116_unpack_57bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 57);
	}
...
static benchmark::BenchmarkReporter::Run bench117_unpack_58bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 58);
	}
...
static benchmark::BenchmarkReporter::Run bench118_unpack_59bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 59);
	}
...
static benchmark::BenchmarkReporter::Run bench119_unpack_60bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 60);
	}
...
static benchmark::BenchmarkReporter::Run bench120_unpack_61bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 61);
	}
...
static benchmark::BenchmarkReporter::Run bench121_unpack_62bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 62);
	}
...
static benchmark::BenchmarkReporter::Run bench122_unpack_63bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 63);
	}
...
static benchmark::BenchmarkReporter::Run bench123_unpack_64bw_64ow_64crw_1uf(const uint64_t* packed64,
	...
	uint64_t cycles = benchmark::cycleclock::Now();
	for (uint64_t i = 0; i < iterations; ++i) {
		generated::unpack::fallback::unit64::unpack(packed64, const_cast<uint64_t*>(unpacked64), 64);
	}
...
int main() {
	benchmark::Benchmark benchmark =
	    benchmark::create("fallback_unit64_nav_1024_uf1_unpack")
	        .save()
