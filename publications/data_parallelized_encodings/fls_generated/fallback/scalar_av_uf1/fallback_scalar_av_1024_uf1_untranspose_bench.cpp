...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/fallback/scalar_av_uf1/fallback_scalar_av_1024_uf1_untranspose_bench.cpp
// ────────────────────────────────────────────────────────
#include "fallback_scalar_av_1024_uf1_untranspose_bench.hpp"
#include "fallback_scalar_av_1024_uf1_untranspose_helper.hpp"
...
int main() {
	benchmark::Benchmark benchmark =
	    benchmark::create("fallback_scalar_av_1024_uf1_untranspose")
	        .save()
