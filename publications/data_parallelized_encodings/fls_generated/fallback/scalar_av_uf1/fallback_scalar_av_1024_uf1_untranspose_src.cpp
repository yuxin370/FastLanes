...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/fallback/scalar_av_uf1/fallback_scalar_av_1024_uf1_untranspose_src.cpp
// ────────────────────────────────────────────────────────
#include "fls_gen/macros.hpp"
#include "fls_gen/untranspose/untranspose.hpp"
namespace generated { namespace untranspose::fallback { namespace scalar {
void untranspose_i(const uint8_t* __restrict a_in_p, uint8_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
...
void untranspose_o(const uint8_t* __restrict a_in_p, uint8_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
...
void untranspose_i(const uint16_t* __restrict a_in_p, uint16_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
...
void untranspose_o(const uint16_t* __restrict a_in_p, uint16_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
...
void untranspose_i(const uint32_t* __restrict a_in_p, uint32_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
...
void untranspose_o(const uint32_t* __restrict a_in_p, uint32_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
...
void untranspose_i(const uint64_t* __restrict a_in_p, uint64_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
...
void untranspose_o(const uint64_t* __restrict a_in_p, uint64_t* __restrict a_out_p) {
	a_out_p[0]    = a_in_p[0];
	a_out_p[64]   = a_in_p[1];
	a_out_p[128]  = a_in_p[2];
	a_out_p[192]  = a_in_p[3];
...
}}} // namespace generated::untranspose::fallback::scalar
