...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/helper/scalar_av_uf1/helper_scalar_av_1024_uf1_rsum_src.cpp
// ────────────────────────────────────────────────────────
#include "fls_gen/macros.hpp"
#include "fls_gen/rsum/rsum.hpp"
namespace generated { namespace rsum::helper { namespace scalar {
...
void rsum(const uint16_t* __restrict a_in_p, uint16_t* __restrict a_out_p, const uint16_t* __restrict a_base_p) {
	...
	[[maybe_unused]] const auto base = reinterpret_cast<const uint16_t*>(a_base_p);
...
void rsum(const uint32_t* __restrict a_in_p, uint32_t* __restrict a_out_p, const uint32_t* __restrict a_base_p) {
	...
	[[maybe_unused]] const auto base = reinterpret_cast<const uint32_t*>(a_base_p);
...
}}} // namespace generated::rsum::helper::scalar
