...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/helper/scalar_av_uf1/helper_scalar_av_1024_uf1_transpose_test.cpp
// ────────────────────────────────────────────────────────
...
class helper_scalar_av_1024_uf1_transpose : public ::testing::Test {
public:
	uint8_t*  transposed8;
	...
	~helper_scalar_av_1024_uf1_transpose() override {
		delete[] transposed8;
		delete[] transposed16;
		delete[] transposed32;
		delete[] transposed64;
