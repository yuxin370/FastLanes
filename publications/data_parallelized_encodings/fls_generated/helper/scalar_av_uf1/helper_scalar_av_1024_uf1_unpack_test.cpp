...
// |                      FastLanes                       |
// ────────────────────────────────────────────────────────
// publications/data_parallelized_encodings/fls_generated/helper/scalar_av_uf1/helper_scalar_av_1024_uf1_unpack_test.cpp
// ────────────────────────────────────────────────────────
#include "fls_gen/pack/pack.hpp"
#include "fls_gen/unpack/unpack.hpp"
#include "helper_scalar_av_1024_uf1_unpack_helper.hpp"
#include "gtest/gtest.h"
class helper_scalar_av_1024_uf1_unpack : public ::testing::Test {
public:
	uint8_t*  packed8;
	uint16_t* packed16;
	uint32_t* packed32;
	...
	~helper_scalar_av_1024_uf1_unpack() override {
		delete[] packed8;
		delete[] packed16;
		delete[] packed32;
		delete[] packed64;
